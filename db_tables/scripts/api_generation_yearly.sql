INSERT IGNORE INTO published.api_generation_yearly (country_or_region, country_code, "year", variable,
    ...
    g20_flag, oecd_flag, region_demand_rank, global_fuel_rank, latest_year, coal_deadline, clean_deadline)
WITH latest_year as(
    ...
    SUM(emissions_estimate_mtco2) as emissions_estimate_mtco2
    FROM mart_generation_yearly_global
    GROUP BY country_name, country_code, "year", variable
)
SELECT
    ...
    country.coal_deadline as coal_deadline,
    country.clean_deadline as clean_deadline
